...
public class SymulatorWycieczki {
    ...
    private Set<SluchaczPostepow> słuchacze = new HashSet<>();
    ...
    public void dodajSłuchacza(SluchaczPostepow słuchacz) {
        słuchacze.add(słuchacz);
    }
    ...
    public void symuluj() {
        ...
        ElementWycieczki elementWycieczki = null;
        int liczbaElementow = wycieczka.getLiczbaElementowWycieczki();

        for (pozycjaGrupy = 0; pozycjaGrupy < liczbaElementow; pozycjaGrupy++) {
            elementWycieczki = wycieczka.getElementWycieczki(pozycjaGrupy);
            ...
            for (SluchaczPostepow słuchacz : słuchacze) {
                słuchacz.aktualizujPostep(elementWycieczki, pozycjaGrupy + 1, liczbaElementow);
            }
